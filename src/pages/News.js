    ...
    return (
        <main>
            <div class="container py-3 py-sm-4">
                ...
                <article class="full">
                    <h1 class="h3 fw_5 rob my-3 my-sm-4 my-sm-5">Как малому бизнесу выжить в условиях коронавируса</h1>
                    ...
                    <hr />
                    <div class="text">
                        <img class="new-page-img" src="images/news/n1.jpg" alt="Как малому бизнесу выживать в условиях коронавируса" />
